...
<body>
    <div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin" method="POST" action="process.php?do=giris">
                <span id="reauth-email" class="reauth-email"></span>
                <input type="password" id="inputPassword" name="passwordx" class="form-control" placeholder="Password" required autofocus>
